...
\begin{document}
 ...
 \hline
  ...
  IF THEN END IF & Syntax: If [relational expr] then statements else statements end if \\ \hline
  
  IF THEN ELSE END IF & Syntax: If [relational expr] then statements else statements end if \\ \hline
  
  SLEEP & \begin{tabular}{l}Sleeps for provided number of seconds\\
